#!/usr/bin/env bats
#
# gox-code-rules specific: the file-bound skills must declare a paths glob so they
...
@test "file-bound skills (go, frontend, shell, python, skill) declare a non-empty paths glob" {
  for name in go frontend shell python skill; do
